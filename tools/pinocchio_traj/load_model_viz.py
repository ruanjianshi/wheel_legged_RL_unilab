...
# ── Load model ──
URDF_PATH = "/home/robot/xiaoq/projects/wheel_legged_genesis/assets/urdf/CJ-003/urdf/CJ-003-wheelfoot.urdf"
...
plt.tight_layout()
plt.savefig('/home/robot/xiaoq/wheel_legged_RL_unilab/tools/pinocchio_traj/toe_walk_pinocchio.png', dpi=150)
plt.close()

print(f"\nMax lift: L={np.max(clearance_l)*1000:.0f}mm, R={np.max(clearance_r)*1000:.0f}mm")
print(f"Saved: tools/pinocchio_traj/toe_walk_pinocchio.png")
