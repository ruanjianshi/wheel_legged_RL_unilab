"""xqrobotwl rough terrain env: procedural terrain + height scan + terrain termination."""
...
class XqRobotWLRoughTerrainCfg(TerrainGeneratorCfg):
...
@registry.envcfg("XqRobotWLWalkRough")
@dataclass
class XqRobotWLWalkRoughCfg(XqRobotWLWalkFlatCfg):
    scene: SceneCfg = field(
        default_factory=lambda: SceneCfg(
            ...
            terrain=TerrainSceneCfg(
                generator=XqRobotWLRoughTerrainCfg(),
...
class XqRobotWLRoughDRProvider(XqRobotWLDRProvider):
...
@registry.env("XqRobotWLWalkRough", sim_backend="mujoco")
class XqRobotWLWalkRoughEnv(XqRobotWLWalkFlatEnv):
    _cfg: XqRobotWLWalkRoughCfg
    ...
    def __init__(self, cfg: XqRobotWLWalkRoughCfg, num_envs=1, backend_type="mujoco"):
        ...
        self._dr_manager = DomainRandomizationManager(self, XqRobotWLRoughDRProvider())
