...
if __name__ == "__main__":
    ...
    # Initialize robot pose: set joint angles to default stance and adjust base height
    data.qpos[7:] = default_angles
    # Compute appropriate base height so feet rest near ground
    # With default_angles [0, 0.9, -1.5], foot is ~0.26m below base, base at ~0.30 gives ground clearance
    data.qpos[2] = 0.30
