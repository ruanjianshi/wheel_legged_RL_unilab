#ifndef PI_PLUS_MOTOR_GROUP_H_
#define PI_PLUS_MOTOR_GROUP_H_
#include "motor/robot_motor_group.h"

namespace hightorque
{
    /** =========================================================================
     * @brief PiPlusMotorGroup 机器人整体电机组控制类
     *
     * 该类负责管理多个命名的电机组（MotorGroup），用于按名称访问和控制子模块（如腿、手臂等）。
     * 提供对电机组状态获取、指令发送、保持状态等接口。
     * ========================================================================= */
    class PiPlusMotorGroup : public RobotMotorGroup
    {
        public:
            PiPlusMotorGroup() = delete;
             ...
             */
            PiPlusMotorGroup(std::shared_ptr<livelybot_serial::robot> rbPtr,
