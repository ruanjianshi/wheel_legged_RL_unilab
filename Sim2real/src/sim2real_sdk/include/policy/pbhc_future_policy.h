#ifndef PBHC_FUTURE_POLICY_H_
#define PBHC_FUTURE_POLICY_H_
...
namespace hightorque
{
     ...
     */
    class PBHCFuturePolicy : public PolicyBase
    {
        public:
            /**
             ...
             */
            PBHCFuturePolicy(const config::RLConfig& rl, const config::PDConfig& pd);
        ...
        private:
            ...
            {
                return numSingleObs_ * frameStack_ + futureSize_;
            }
    };
}
