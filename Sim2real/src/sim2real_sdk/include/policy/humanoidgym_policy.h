#ifndef HUMANOIDGYM_POLICY_H_
#define HUMANOIDGYM_POLICY_H_
...
{
    /**
     * @brief 针对 HumanoidGym 环境的策略基类实现
     */
    class HumanoidgymPolicy : public PolicyBase
    {
        public:
            /**
             ...
             */
            HumanoidgymPolicy(const config::RLConfig rl, const config::PDConfig pd);
             ...
             */
            HumanoidgymPolicy(double frequency,
