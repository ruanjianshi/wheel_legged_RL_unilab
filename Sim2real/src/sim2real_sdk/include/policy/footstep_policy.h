#ifndef FOOTSTEP_POLICY_H_
#define FOOTSTEP_POLICY_H_
...
namespace hightorque
{
     ...
     * @brief 针对步态周期的策略实现
     */
    class FootStepPolicy : public PolicyBase
    {
        public:
            /**
             ...
             */
            FootStepPolicy(const config::RLConfig rl, const config::PDConfig pd);
             ...
             */
            FootStepPolicy(const int stepsPerCycle,
        ...
        private:
            ...
            // 速度限制参数
            double cmd_vel_x_min_;
            double cmd_vel_x_max_;
            double cmd_vel_y_min_;
            double cmd_vel_y_max_;
            double cmd_vel_yaw_min_;
            double cmd_vel_yaw_max_;
    };
}
