...
FLAT_WALK_DECOUPLING = EvalSuite(
    ...
    scenarios=[
        EvalScenario("fwd_vx=0.6", [0.6, 0.0, 0.0, 0.0, 0.65],
                     description="Forward high speed"),
        EvalScenario("fwd_vx=0.3", [0.3, 0.0, 0.0, 0.0, 0.65],
                     description="Forward medium speed"),
        EvalScenario("fwd_vx=-0.3", [-0.3, 0.0, 0.0, 0.0, 0.65],
                     description="Backward"),
        EvalScenario("lat_vy=+0.3", [0.0, 0.3, 0.0, 0.0, 0.65],
                     description="Strafe right"),
        EvalScenario("lat_vy=-0.3", [0.0, -0.3, 0.0, 0.0, 0.65],
                     description="Strafe left"),
        EvalScenario("fwd+lat", [0.3, 0.2, 0.0, 0.0, 0.65],
...
STANDING_STABILITY = EvalSuite(
    ...
    scenarios=[
        EvalScenario("stand", [0.0, 0.0, 0.0, 0.0, 0.65],
...
def load_suite(path: str | Path) -> EvalSuite:
    ...
    scenarios = [
        EvalScenario(**s) for s in data.pop("scenarios", [])
    ]
