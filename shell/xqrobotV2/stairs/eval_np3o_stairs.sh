...
# 用法:
#   bash shell/xqrobotV2/stairs/eval_np3o_stairs.sh                          # 最新模型, 策略回放
#   bash shell/xqrobotV2/stairs/eval_np3o_stairs.sh --keyboard                # 最新模型, 键盘遥控
#   bash shell/xqrobotV2/stairs/eval_np3o_stairs.sh <run_id>                  # 指定 run, 策略回放
