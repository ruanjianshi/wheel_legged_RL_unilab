...
# 用法:
#   bash shell/xqrobotV2/tools/xqrobotV2_tb.sh              # 默认端口 6006
#   bash shell/xqrobotV2/tools/xqrobotV2_tb.sh 8080          # 指定端口
# ============================================================
set -e
...
if [ ! -d "$LOG_DIR" ]; then
    ...
    echo "先运行训练: bash shell/xqrobotV2/flat/train_ppo_flat.sh"
    exit 1
fi
