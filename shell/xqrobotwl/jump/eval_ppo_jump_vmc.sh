#!/bin/bash
# ============================================================
# XqRobotWL PPO+VMC 跳跃策略验证 (平坦地形 + 键盘控制)
# 用法:
#   bash shell/xqrobotwl/jump/eval_ppo_jump_vmc.sh             # 最新模型
#   bash shell/xqrobotwl/jump/eval_ppo_jump_vmc.sh --keyboard    # 键盘: J=跳跃
#   bash shell/xqrobotwl/jump/eval_ppo_jump_vmc.sh <run_id> --keyboard
set -e
...
CMD="$CMD --algo ppo --task xqrobotwl_jump_vmc_flat --sim mujoco"
