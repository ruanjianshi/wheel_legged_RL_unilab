...
# 用法:
#   bash shell/xqrobotwl/train_ppo_single_leg.sh              # 全量 10000 iter
#   bash shell/xqrobotwl/train_ppo_single_leg.sh quick         # 快速验证 500 iter
#   bash shell/xqrobotwl/train_ppo_single_leg.sh 1000          # 指定迭代数
#   bash shell/xqrobotwl/train_ppo_single_leg.sh warmstart     # 热启动 walk 平衡
#   bash shell/xqrobotwl/train_ppo_single_leg.sh resume        # 续训最新
# ============================================================
set -e
