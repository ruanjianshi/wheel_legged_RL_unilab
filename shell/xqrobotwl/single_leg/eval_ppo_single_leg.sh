#!/bin/bash
# ============================================================
# XqRobotWL 单腿平衡策略验证 (MuJoCo 原生窗口 + 键盘控制)
# 用法:
#   bash shell/xqrobotwl/single_leg/eval_ppo_single_leg.sh            # 最新 run
#   bash shell/xqrobotwl/single_leg/eval_ppo_single_leg.sh --keyboard
#   bash shell/xqrobotwl/single_leg/eval_ppo_single_leg.sh 2000       # 指定 checkpoint
#   bash shell/xqrobotwl/single_leg/eval_ppo_single_leg.sh <run_id>
# ============================================================
...
CMD="$CMD --algo ppo --task xqrobotwl_single_leg_flat --sim mujoco"
