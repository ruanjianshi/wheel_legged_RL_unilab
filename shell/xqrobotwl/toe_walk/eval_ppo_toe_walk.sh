...
# XqRobotWL 点足行走策略验证
# 用法:
#   bash shell/xqrobotwl/toe_walk/eval_ppo_toe_walk.sh             # 最新模型
#   bash shell/xqrobotwl/toe_walk/eval_ppo_toe_walk.sh --keyboard    # 键盘控制
# ============================================================
set -e
...
CMD="$CMD --algo ppo --task xqrobotwl_toe_walk_flat --sim mujoco"
