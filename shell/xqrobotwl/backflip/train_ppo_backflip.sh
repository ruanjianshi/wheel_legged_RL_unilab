...
# 用法:
#   bash shell/xqrobotwl/train_ppo_backflip.sh              # 全量 10000 iter
#   bash shell/xqrobotwl/train_ppo_backflip.sh quick         # 快速验证 200 iter
#   bash shell/xqrobotwl/train_ppo_backflip.sh 1000          # 指定迭代数
# ============================================================
set -e
