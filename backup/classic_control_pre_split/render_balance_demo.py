...
from scripts.classic_control.config import STANDING_ANGLES
from scripts.classic_control.render import states_to_video
...
def demo_success_env(out: Path, sim_s: float = 5.0) -> None:
    ...
    from scripts.classic_control import rollout as rollout_mod
    from scripts.classic_control.config import DEFAULT_LEG_ANGLES
...
def demo_p2(out: Path, sim_s: float = 25.0) -> None:
    ...
    from scripts.classic_control.run import get_dynamics
