...
用法:
  uv run python scripts/xqrobotwl/fall_recovery_feasibility.py            # 默认(仰卧)
  uv run python scripts/xqrobotwl/fall_recovery_feasibility.py --prone     # 俯卧
  uv run python scripts/xqrobotwl/fall_recovery_feasibility.py --render /tmp/fall_rec
"""
