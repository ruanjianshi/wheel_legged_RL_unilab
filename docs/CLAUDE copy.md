...
- 项目架构: `README.md`
- 架构标准与验证详情：[sphinx/source/zh_CN/4-developer_guide/0-index.md](sphinx/source/zh_CN/4-developer_guide/0-index.md)
- 协作流程与 PR 规范：[sphinx/source/zh_CN/4-developer_guide/5-contributing_workflow.md](sphinx/source/zh_CN/4-developer_guide/5-contributing_workflow.md)
- 开发者入口（环境、命令、提交规范）：本文件 (CLAUDE.md)
- 文档本地构建与发布到 UniLab-doc：[sphinx/README.md#本地发布到-unilab-doc](sphinx/README.md#本地发布到-unilab-doc)
